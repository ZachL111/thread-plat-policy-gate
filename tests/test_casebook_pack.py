"""Regression checks for the thread-plat-policy-gate casebook."""
...
from casebook.harness import assert_expected, thread_plat_policy_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_plat_policy_gate_summary(), assert_expected())
